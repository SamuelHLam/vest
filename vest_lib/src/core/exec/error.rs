...
// impl GenerateError {
//     /// Creates a new generate error.
//     pub fn new(kind: GenerateErrorKind) -> (e: Self)
//         ensures
//             e.kind == kind,
//     {
//         Self {
...
//         Self::new(GenerateErrorKind::Generic)
//     }
// }
...
//         let format_trace = self.format_trace();
//         if !format_trace.is_empty() {
//             write!(f, "{} while generating format stack ", self.kind)?;
//             for (i, format_name) in format_trace.iter().rev().enumerate() {
//                 if i > 0 {
//                     f.write_str(" -> ")?;
//                 }
...
//             match self.failed_format {
//                 Some(current_format) => {
//                     write!(f, "{} while generating format `{}`", self.kind, current_format)
//                 }
//                 None => write!(f, "{}", self.kind),
//             }
//         }
...
// impl Clone for GenerateErrorKind {
//     fn clone(&self) -> Self {
//         *self
//     }
// }
...
//     fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
//         match self {
//             GenerateErrorKind::Generic => {
//                 f.write_str("generic generation error")
//             }
//         }
//     }
// }
