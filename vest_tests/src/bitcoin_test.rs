...
# [verifier::ext_equal]
pub struct BlockSpec < T0 = u32, T1 = Seq < u8 >, T2 = Seq < u8 >, T3 = u32, T4 = u32, T5 = u32, T6 = u64, T7 = Seq < TxSpec > > {
    pub version: T0,
    pub prev_block: T1,
    pub merkle_root: T2,
    pub timestamp: T3,
...
impl<'i> Block<'i> {
    pub proof fn lemma_deep_view_fields (& self) ensures self.deep_view().version == self.version.deep_view(),
...
# [verifier::ext_equal]
pub struct TxSegwitSpec < T0 = u8, T1 = u64, T2 = Seq < TxinSpec >, T3 = u64, T4 = Seq < TxoutSpec >, T5 = Seq < WitnessSpec >, T6 = LockTimeSpec > {
    pub flag: T0,
    pub txin_count: T1,
    pub txins: T2,
    pub txout_count: T3,
...
impl<'i> TxSegwit<'i> {
    pub proof fn lemma_deep_view_fields (& self) ensures self.deep_view().flag == self.flag.deep_view(),
    self.deep_view().txin_count == self.txin_count.deep_view(),
...
impl<'i> WitnessComponent<'i> {
    pub proof fn lemma_deep_view_fields (& self) ensures self.deep_view().l == self.l.deep_view(),
    self.deep_view().data == self.data.deep_view(),
    {
...
impl<'i> TxNonsegwit<'i> {
    pub proof fn lemma_deep_view_fields (& self) ensures self.deep_view().txins == self.txins.deep_view(),
    self.deep_view().txout_count == self.txout_count.deep_view(),
    self.deep_view().txouts == self.txouts.deep_view(),
    self.deep_view().lock_time == self.lock_time.deep_view(),
    {
...
impl<'i> Txin<'i> {
    pub proof fn lemma_deep_view_fields (& self) ensures self.deep_view().previous_output == self.previous_output.deep_view(),
...
impl<'i> Outpoint<'i> {
    pub proof fn lemma_deep_view_fields (& self) ensures self.deep_view().hash == self.hash.deep_view(),
...
pub type BlockFmtSpec = Named < Mapped < Pair < U32Le, Pair < Fixed < 32 >, Pair < Fixed < 32 >, Pair < U32Le, Pair < U32Le, Pair < U32Le, Bind < VarInt < true >, spec_fn (u64) -> RepeatN < TxFmt, u64 > > > > > > > >, BiMap < BlockForward, BlockReverse >> > ;
...
impl BlockFmt {
    # [doc = "specification constructor for `block`."] pub open spec fn spec_inner() -> BlockFmtSpec {
        ...
        Mapped {
            ...
            Pair (U32Le,
            Bind (VarInt::< true >,
            | tx_count: u64 | RepeatN (tx_count,
            TxFmt)))))))),
            mapper: BiMap (BlockForward,
            BlockReverse),
        }
        )
    }
...
pub type TxFmtSpec = Named < Mapped < Pair < U32Le, Bind < VarInt < true >, spec_fn (u64) -> TxRemFmt > >, BiMap < TxForward, TxReverse >> > ;
...
pub type TxSegwitFmtSpec = Named < Mapped < Pair < Const < U8, u8 >, Bind < VarInt < true >, spec_fn (u64) -> Pair < RepeatN < TxinFmt, u64 >, Bind < VarInt < true >, spec_fn (u64) -> Pair < RepeatN < TxoutFmt, u64 >, Pair < RepeatN < WitnessFmt, u64 >, LockTimeFmt > > > > > >, BiMap < TxSegwitForward, TxSegwitReverse >> > ;
...
impl TxSegwitFmt {
    # [doc = "specification constructor for `tx_segwit`."] pub open spec fn spec_inner() -> TxSegwitFmtSpec {
        ...
        Mapped {
            ...
            1),
            Bind (VarInt::< true >,
            | txin_count: u64 | Pair (RepeatN (txin_count,
            TxinFmt),
            Bind (VarInt::< true >,
            | txout_count: u64 | Pair (RepeatN (txout_count,
            TxoutFmt),
            Pair (RepeatN (txin_count,
            WitnessFmt),
            LockTimeFmt)))))),
            mapper: BiMap (TxSegwitForward,
            TxSegwitReverse),
        }
        )
    }
...
pub type WitnessFmtSpec = Named < Mapped < Bind < VarInt < true >, spec_fn (u64) -> RepeatN < WitnessComponentFmt, u64 > >, BiMap < WitnessForward, WitnessReverse >> > ;
...
pub type WitnessComponentFmtSpec = Named < Mapped < Bind < VarInt < true >, spec_fn (u64) -> Varied < u64 > >, BiMap < WitnessComponentForward, WitnessComponentReverse >> > ;
...
impl WitnessComponentFmt {
    # [doc = "specification constructor for `witness_component`."] pub open spec fn spec_inner() -> WitnessComponentFmtSpec {
        ...
        Mapped {
            inner: Bind (VarInt::< true >,
            | l: u64 | Varied (l)),
            mapper: BiMap (WitnessComponentForward,
            WitnessComponentReverse),
        }
        )
    }
}
...
pub type TxNonsegwitFmtSpec = Named < Mapped < Pair < RepeatN < TxinFmt, u64 >, Bind < VarInt < true >, spec_fn (u64) -> Pair < RepeatN < TxoutFmt, u64 >, LockTimeFmt > > >, BiMap < TxNonsegwitForward, TxNonsegwitReverse >> > ;

impl TxNonsegwitFmt {
    # [doc = "specification constructor for `tx_nonsegwit`."] pub open spec fn spec_inner (txin_count: u64) -> TxNonsegwitFmtSpec {
        Named ("tx_nonsegwit",
        Mapped {
            inner: Pair (RepeatN (txin_count,
            TxinFmt),
            Bind (VarInt::< true >,
            | txout_count: u64 | Pair (RepeatN (txout_count,
            TxoutFmt),
            LockTimeFmt))),
            mapper: BiMap (TxNonsegwitForward,
            TxNonsegwitReverse),
        }
        )
    }
...
pub type LockTimeFmtSpec = Named < Mapped < Choice < Refined < U32Le, PredFnSpec < u32 >>, Refined < U32Le, PredFnSpec < u32 >> >, BiMap < LockTimeForward, LockTimeReverse >> > ;
...
pub type ScriptFmtSpec = Named < Mapped < Bind < VarInt < true >, spec_fn (u64) -> Varied < u64 > >, BiMap < ScriptForward, ScriptReverse >> > ;
...
pub type TxinFmtSpec = Named < Mapped < Pair < OutpointFmt, Pair < ScriptSigFmt, U32Le > >, BiMap < TxinForward, TxinReverse >> > ;
...
pub type OutpointFmtSpec = Named < Mapped < Pair < Fixed < 32 >, U32Le >, BiMap < OutpointForward, OutpointReverse >> > ;
...
pub type ScriptSigFmtSpec = Named < Mapped < Bind < VarInt < true >, spec_fn (u64) -> Varied < u64 > >, BiMap < ScriptSigForward, ScriptSigReverse >> > ;
...
pub type TxRemFmtSpec = Named < Mapped < Sum < TxSegwitFmt, TxNonsegwitFmt >, BiMap < TxRemForward, TxRemReverse >> > ;
...
mod derived_specs {
    ...
    impl SpecSerializerDps for TxNonsegwitFmt {
        ...
        v: Self::SValue,
        obuf: Seq < u8 >) -> Seq < u8 > {
            Self::spec_inner (self.txin_count_spec()).spec_serialize_dps (v,
            obuf)
        }
    }
...
mod derived_proofs {
    ...
    impl SoundParser for BlockFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: BlockInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for BlockFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< BlockFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: BlockSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for TxFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: TxInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for TxFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< TxFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: TxSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for TxSegwitFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: TxSegwitInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for TxSegwitFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< TxSegwitFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: TxSegwitSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for WitnessFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: WitnessInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for WitnessFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< WitnessFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: WitnessSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for WitnessComponentFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: WitnessComponentInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for WitnessComponentFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< WitnessComponentFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: WitnessComponentSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for TxNonsegwitFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner (self.txin_count_spec()) ;
            assert forall | input: TxNonsegwitInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for TxNonsegwitFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< TxNonsegwitFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner (self.txin_count_spec()) ;
            assert forall | output: TxNonsegwitSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for LockTimeFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: LockTimeInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for LockTimeFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< LockTimeFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: LockTimeSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for TxoutFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: TxoutInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for TxoutFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< TxoutFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: TxoutSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for ScriptFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: ScriptInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for ScriptFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< ScriptFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: ScriptSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for TxinFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: TxinInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for TxinFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< TxinFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: TxinSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for OutpointFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: OutpointInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for OutpointFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< OutpointFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: OutpointSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for ScriptSigFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner() ;
            assert forall | input: ScriptSigInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for ScriptSigFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< ScriptSigFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner() ;
            assert forall | output: ScriptSigSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
    ...
    impl SoundParser for TxRemFmt {
        ...
        ibuf: Seq < u8 >) {
            ...
            let fmt = Self::spec_inner (self.txin_count_spec()) ;
            assert forall | input: TxRemInner | # [trigger] fmt.1.inner.consistent (input) implies fmt.1.mapper.lossless (input) by {
    ...
    impl SPRoundTripDps for TxRemFmt {
        ...
        obuf: Seq < u8 >) {
            ...
            reveal(< TxRemFmt as SpecByteLen>::byte_len) ;
            let fmt = Self::spec_inner (self.txin_count_spec()) ;
            assert forall | output: TxRemSpec | # [trigger] fmt.1.consistent (output) implies fmt.1.mapper.sound (output) by {
...
mod exec_impls {
    ...
    impl<'i> Parser<&'i [u8]> for TxFmt {
        ...
        fn parse(&self, ibuf: &&'i [u8]) -> PResult<Self::PT> {
            ...
            let rest = rest.skip(n2);
            let (n3, rem) = (Named ("tx_rem", TxRemFmt {
    ...
    impl<'i> Prepare<TxRem<'i>> for TxRemFmt {
        fn prepare(&self, v: &TxRem<'i>) -> Result<usize, PreSerializeError> {
            ...
            match (self.txin_count, v) {
                ...
                (x, TxRem::Default (v)) if ! (x == 0) => (Named ("tx_nonsegwit", TxNonsegwitFmt {
                    txin_count: self.txin_count
                }
                )).prepare (v),
